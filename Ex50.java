/*50º) Realizando através de busca binária recursiva, resolver o exercício no. 40 desta lista.
...
public class Ex50 {
    public static void main(String[] args) {
        ...
        vetor = ordenarVetorDecrescente(vetor);
    ...
    public static char[] ordenarVetorDecrescente(char[] vetor) {
        return ordenarVetorDecrescente(vetor, 0, vetor.length - 1);
    }

    public static char[] ordenarVetorDecrescente(char[] vetor, int inicio, int fim) {
        if (inicio >= fim) {
            return vetor;
        }
        ...
        return ordenarVetorDecrescente(vetor, inicio + 1, fim - 1);
    }
